window.app = {
	 ...
	 * 后端服务器发布的url
	 */
	serverUrl: 'http://172.20.10.9:8080',

	/**
	 * 图片服务器的url
	 */
	imgServerUrl: 'http://106.54.20.226:88/wechat/',
	...
	/**
	 * @param {Object} friendId根据用户的id，从联系人列表中，获取朋友的信息
	 */
	 ...
	 * @param {Object} friendId
	 * @param {Object} msg
	 * @param {Object} flag 判断该条记录是我发送的还是朋友发送的 1：我发送的 2：朋友发送的
	 */
	...
	saveUserSnapshot: function(myId, friendId, msg, isRead) {
		...
		if (me.isNotNull(chatsnapshotListStr)) {
			...
			//循环快照list,并判断每个元素是否包含（匹配）friendId，如果包好则删除
			for (var i = 0; i < chatSnapshotList.length; i++) {
				if (chatSnapshotList[i].friendId == friendId) {
					//删除已经存在的friendId所对应的的快照对象
